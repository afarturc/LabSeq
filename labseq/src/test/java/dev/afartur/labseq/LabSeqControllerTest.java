...
public class LabSeqControllerTest {
    ...
    @Test
    public void givenValidInteger_whenCalculationLabSeq_thenReturnLabSeqResponse() throws Exception {
    ...
    @Test
    public void givenInvalidInteger_whenCalculationLabSeq_thenReturnExceptionResponse() throws Exception {
